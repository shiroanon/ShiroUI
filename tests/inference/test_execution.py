...
import urllib.parse
import urllib.error
from shiro_execution.graph_utils import GraphBuilder, Node
...
class TestExecution:
    ...
    def start_client(self, listen:str, port:int):
        # Start client
        shiro_client = ShiroClient()
        # Connect to server (with retries)
        n_tries = 5
        for i in range(n_tries):
            time.sleep(4)
            try:
                shiro_client.connect(listen=listen, port=port)
    ...
    def test_lazy_input(self, client: ShiroClient, builder: GraphBuilder):
        g = builder
    ...
    def test_full_cache(self, client: ShiroClient, builder: GraphBuilder):
        g = builder
        input1 = g.node("StubImage", content="BLACK", height=512, width=512, batch_size=1)
    ...
    def test_partial_cache(self, client: ShiroClient, builder: GraphBuilder):
        g = builder
        input1 = g.node("StubImage", content="BLACK", height=512, width=512, batch_size=1)
        input2 = g.node("StubImage", content="NOISE", height=512, width=512, batch_size=1)
        mask = g.node("StubMask", value=0.5, height=512, width=512, batch_size=1)
    ...
    def test_error(self, client: ShiroClient, builder: GraphBuilder):
        g = builder
        input1 = g.node("StubImage", content="BLACK", height=512, width=512, batch_size=1)
    ...
    def test_validation_error_literal(self, test_value, expect_error, client: ShiroClient, builder: GraphBuilder):
        g = builder
    ...
    def test_validation_error_edge1(self, test_type, test_value, client: ShiroClient, builder: GraphBuilder):
        g = builder
    ...
    def test_validation_error_edge2(self, test_type, test_value, expect_error, client: ShiroClient, builder: GraphBuilder):
        g = builder
        stub = g.node(test_type, value=test_value)
    ...
    def test_validation_error_edge3(self, test_type, test_value, expect_error, client: ShiroClient, builder: GraphBuilder):
        g = builder
        stub = g.node(test_type, value=test_value)
    ...
    def test_validation_error_edge4(self, test_type, test_value, expect_error, client: ShiroClient, builder: GraphBuilder):
        g = builder
        stub = g.node(test_type, value=test_value)
    ...
    def test_validation_error_kwargs(self, test_value1, test_value2, expect_error, client: ShiroClient, builder: GraphBuilder):
        g = builder
    ...
    def test_cycle_error(self, client: ShiroClient, builder: GraphBuilder):
        g = builder
        input1 = g.node("StubImage", content="BLACK", height=512, width=512, batch_size=1)
        input2 = g.node("StubImage", content="WHITE", height=512, width=512, batch_size=1)
        mask = g.node("StubMask", value=0.5, height=512, width=512, batch_size=1)
    ...
    def test_dynamic_cycle_error(self, client: ShiroClient, builder: GraphBuilder):
        g = builder
        input1 = g.node("StubImage", content="BLACK", height=512, width=512, batch_size=1)
        input2 = g.node("StubImage", content="WHITE", height=512, width=512, batch_size=1)
    ...
    def test_missing_node_error(self, client: ShiroClient, builder: GraphBuilder):
        g = builder
        input1 = g.node("StubImage", content="BLACK", height=512, width=512, batch_size=1)
    ...
    def test_custom_is_changed(self, client: ShiroClient, builder: GraphBuilder):
        g = builder
    ...
    def test_undeclared_inputs(self, client: ShiroClient, builder: GraphBuilder):
        g = builder
        input1 = g.node("StubImage", content="BLACK", height=512, width=512, batch_size=1)
        input2 = g.node("StubImage", content="WHITE", height=512, width=512, batch_size=1)
    ...
    def test_for_loop(self, client: ShiroClient, builder: GraphBuilder):
        g = builder
        iterations = 4
        input1 = g.node("StubImage", content="BLACK", height=512, width=512, batch_size=1)
        input2 = g.node("StubImage", content="WHITE", height=512, width=512, batch_size=1)
    ...
    def test_mixed_expansion_returns(self, client: ShiroClient, builder: GraphBuilder):
        g = builder
    ...
    def test_mixed_lazy_results(self, client: ShiroClient, builder: GraphBuilder):
        g = builder
    ...
    def test_output_reuse(self, client: ShiroClient, builder: GraphBuilder):
        g = builder
        input1 = g.node("StubImage", content="BLACK", height=512, width=512, batch_size=1)
    ...
    def test_is_changed_with_outputs(self, client: ShiroClient, builder: GraphBuilder):
        g = builder
    ...
    def test_execution_block_list_output(self, client: ShiroClient, builder: GraphBuilder):
        g = builder
