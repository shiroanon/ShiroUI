...
from shiro.ldm.util import exists
import shiro.patcher_extension
import shiro.ops
ops = shiro.ops.disable_weight_init
...
class UNetModel(nn.Module):
    ...
    def forward(self, x, timesteps=None, context=None, y=None, control=None, transformer_options={}, **kwargs):
        return shiro.patcher_extension.WrapperExecutor.new_class_executor(
            self._forward,
            self,
            shiro.patcher_extension.get_all_wrappers(shiro.patcher_extension.WrappersMP.DIFFUSION_MODEL, transformer_options)
