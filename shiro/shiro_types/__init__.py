...
from .node_typing import IO, InputTypeDict, ShiroNodeABC, CheckLazyMixin


class UnetApplyFunction(Protocol):
    """Function signature protocol on shiro.model_base.BaseModel.apply_model"""
