# Shiro Typing
## Type hinting for ShiroUI Node development

This module provides type hinting and concrete convenience types for node developers.
If cloned to the custom_nodes directory of ShiroUI, types can be imported using:

```python
from shiro.shiro_types import IO, ShiroNodeABC, CheckLazyMixin

class ExampleNode(ShiroNodeABC):
    @classmethod
