...
class SD20(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        return supported_models_base.ClipTarget(shiro.text_encoders.sd2_clip.SD2Tokenizer, shiro.text_encoders.sd2_clip.SD2ClipModel)
...
class SD3(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        ...
        if "{}clip_g.transformer.text_model.final_layer_norm.weight".format(pref) in state_dict:
            clip_g = True
        t5_detect = shiro.text_encoders.sd3_clip.t5_xxl_detect(state_dict, "{}t5xxl.transformer.".format(pref))
        if "dtype_t5" in t5_detect:
            t5 = True

        return supported_models_base.ClipTarget(shiro.text_encoders.sd3_clip.SD3Tokenizer, shiro.text_encoders.sd3_clip.sd3_clip(clip_l=clip_l, clip_g=clip_g, t5=t5, **t5_detect))
...
class StableAudio(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        return supported_models_base.ClipTarget(shiro.text_encoders.sa_t5.SAT5Tokenizer, shiro.text_encoders.sa_t5.SAT5Model)
...
class AuraFlow(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        return supported_models_base.ClipTarget(shiro.text_encoders.aura_t5.AuraT5Tokenizer, shiro.text_encoders.aura_t5.AuraT5Model)
...
class PixArtAlpha(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        return supported_models_base.ClipTarget(shiro.text_encoders.pixart_t5.PixArtTokenizer, shiro.text_encoders.pixart_t5.PixArtT5XXL)
...
class HunyuanDiT(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        return supported_models_base.ClipTarget(shiro.text_encoders.hydit.HyditTokenizer, shiro.text_encoders.hydit.HyditModel)
...
class Flux(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        pref = self.text_encoder_key_prefix[0]
        t5_detect = shiro.text_encoders.sd3_clip.t5_xxl_detect(state_dict, "{}t5xxl.transformer.".format(pref))
        return supported_models_base.ClipTarget(shiro.text_encoders.flux.FluxTokenizer, shiro.text_encoders.flux.flux_clip(**t5_detect))
...
class GenmoMochi(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        pref = self.text_encoder_key_prefix[0]
        t5_detect = shiro.text_encoders.sd3_clip.t5_xxl_detect(state_dict, "{}t5xxl.transformer.".format(pref))
        return supported_models_base.ClipTarget(shiro.text_encoders.genmo.MochiT5Tokenizer, shiro.text_encoders.genmo.mochi_te(**t5_detect))
...
class LTXV(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        pref = self.text_encoder_key_prefix[0]
        t5_detect = shiro.text_encoders.sd3_clip.t5_xxl_detect(state_dict, "{}t5xxl.transformer.".format(pref))
        return supported_models_base.ClipTarget(shiro.text_encoders.lt.LTXVT5Tokenizer, shiro.text_encoders.lt.ltxv_te(**t5_detect))
...
class HunyuanVideo(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        pref = self.text_encoder_key_prefix[0]
        hunyuan_detect = shiro.text_encoders.hunyuan_video.llama_detect(state_dict, "{}llama.transformer.".format(pref))
        return supported_models_base.ClipTarget(shiro.text_encoders.hunyuan_video.HunyuanVideoTokenizer, shiro.text_encoders.hunyuan_video.hunyuan_video_clip(**hunyuan_detect))
...
class CosmosT2V(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        pref = self.text_encoder_key_prefix[0]
        t5_detect = shiro.text_encoders.sd3_clip.t5_xxl_detect(state_dict, "{}t5xxl.transformer.".format(pref))
        return supported_models_base.ClipTarget(shiro.text_encoders.cosmos.CosmosT5Tokenizer, shiro.text_encoders.cosmos.te(**t5_detect))
...
class Lumina2(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        pref = self.text_encoder_key_prefix[0]
        hunyuan_detect = shiro.text_encoders.hunyuan_video.llama_detect(state_dict, "{}gemma2_2b.transformer.".format(pref))
        return supported_models_base.ClipTarget(shiro.text_encoders.lumina2.LuminaTokenizer, shiro.text_encoders.lumina2.te(**hunyuan_detect))
...
class WAN21_T2V(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        pref = self.text_encoder_key_prefix[0]
        t5_detect = shiro.text_encoders.sd3_clip.t5_xxl_detect(state_dict, "{}umt5xxl.transformer.".format(pref))
        return supported_models_base.ClipTarget(shiro.text_encoders.wan.WanT5Tokenizer, shiro.text_encoders.wan.te(**t5_detect))
