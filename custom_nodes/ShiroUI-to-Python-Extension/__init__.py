...
try:
    ...
    print("Unable to import requirements for shiroUI-SaveAsScript.")
    print("Installing...")
...
os.environ["RUNNING_IN_shiroUI"] = "TRUE"

from shiroui_to_python import shiroUItoPython
...
async def save_as_script(request):
    try:
        ...
        sio = StringIO()
        shiroUItoPython(workflow=workflow, output_file=sio)
