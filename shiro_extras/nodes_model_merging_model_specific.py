import shiro_extras.nodes_model_merging

class ModelMergeSD1(shiro_extras.nodes_model_merging.ModelMergeBlocks):
...
class ModelMergeSDXL(shiro_extras.nodes_model_merging.ModelMergeBlocks):
    CATEGORY = "advanced/model_merging/model_specific"
...
class ModelMergeSD3_2B(shiro_extras.nodes_model_merging.ModelMergeBlocks):
    CATEGORY = "advanced/model_merging/model_specific"
...
class ModelMergeAuraflow(shiro_extras.nodes_model_merging.ModelMergeBlocks):
    CATEGORY = "advanced/model_merging/model_specific"
...
class ModelMergeFlux1(shiro_extras.nodes_model_merging.ModelMergeBlocks):
    CATEGORY = "advanced/model_merging/model_specific"
...
class ModelMergeSD35_Large(shiro_extras.nodes_model_merging.ModelMergeBlocks):
    CATEGORY = "advanced/model_merging/model_specific"
...
class ModelMergeMochiPreview(shiro_extras.nodes_model_merging.ModelMergeBlocks):
    CATEGORY = "advanced/model_merging/model_specific"
...
class ModelMergeLTXV(shiro_extras.nodes_model_merging.ModelMergeBlocks):
    CATEGORY = "advanced/model_merging/model_specific"
...
class ModelMergeCosmos7B(shiro_extras.nodes_model_merging.ModelMergeBlocks):
    CATEGORY = "advanced/model_merging/model_specific"
...
class ModelMergeCosmos14B(shiro_extras.nodes_model_merging.ModelMergeBlocks):
    CATEGORY = "advanced/model_merging/model_specific"
